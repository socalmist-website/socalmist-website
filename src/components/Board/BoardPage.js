        ...
        <Container style={{ "margin-top": "3em" }}>
          <Row className="justify-content-sm-center">
            <Col lg={4} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img className = "top2" src={maria_director} height="250px"></img>
              <h4 className="boardMemName">Maria Najam</h4>
              <h5 className="boardPos">Regional Director</h5>
            </Col>
            <Col lg={4} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img className ="top2" src={salma_director} height="250px"></img>
          ...
          <Row className="justify-content-sm-center">
            ...
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={amr_volun} height="200px"></img>
          ...
          <img src={raahima_logistcs} className ="boardPic" height="200px"></img>
          ...
          <Row className="justify-content-sm-center">
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={juhaina_comp} height="200px"></img>
              <h4 className="boardMemName">Juhaina Habeebulla</h4>
              <h5 className="boardPos">Category Head</h5>
            </Col>
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={zainab_comp} height="200px"></img>
              <h4 className="boardMemName">Zainab Khan</h4>
              <h5 className="boardPos">Category Head</h5>
            </Col>
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={saalim_comp} height="200px"></img>
          ...
          <Row className="justify-content-sm-center">
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={faaizah_comp} height="200px"></img>
              <h4 className="boardMemName">Faaizah Saiduddin</h4>
              <h5 className="boardPos">Category Head</h5>
            </Col>
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={meraal_comp} height="200px"></img>
          ...
          <Row className="justify-content-sm-center">
          <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
            <img src={sadaf_comp} height="200px"></img>
          ...
          <Row className="justify-content-sm-center">
            ...
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={asra_logistics} height="200px"></img>
          ...
          <Row className="justify-content-sm-center">
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={sana_regis} height="200px"></img>
              <h4 className="boardMemName">Sana Khan</h4>
              <h5 className="boardPos">Registration Coordinator</h5>
            </Col>
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={summer_regis} height="200px"></img>
              <h4 className="boardMemName">Summer Kurdi</h4>
              <h5 className="boardPos">Registration Coordinator</h5>
            </Col>
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={husna_finance} height="200px"></img>
          ...
          <Row className="justify-content-sm-center">           
            <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              ...
              <Col lg={3} style={{ 'text-align': 'center', "margin-top": "2em" }}>
              <img src={sara_comp} height="200px"></img>
