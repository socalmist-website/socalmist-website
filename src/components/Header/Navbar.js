          ...
          <NavDropdown title="Competitions">
            ...
            <NavItem>
              <NavDropdown title="Arts" drop="right">
                <NavDropdown.Item href="/competition">2D Arts</NavDropdown.Item>
                <NavDropdown.Item href="/competition">3D Arts</NavDropdown.Item>
                <NavDropdown.Item href="/competition">
                  Fashion Design
                </NavDropdown.Item>
                <NavDropdown.Item href="/competition">
            ...
            <NavItem>
              <NavDropdown title="Writing & Oratory" drop="right">
                ...
                <NavDropdown.Item href="/competition">Poetry</NavDropdown.Item>
                <NavDropdown.Item href="/competition">
                  Prepared Essay
                </NavDropdown.Item>
                <NavDropdown.Item href="/competition">
            ...
            <NavItem>
              <NavDropdown title="Brackets" drop="right">
                <NavDropdown.Item href="/competition">Debate</NavDropdown.Item>
                <NavDropdown.Item href="/competition">
                  Math Olympics
                </NavDropdown.Item>
                <NavDropdown.Item href="/competition">
                ...
                <NavDropdown.Item href="/competition">Improv</NavDropdown.Item>
              </NavDropdown>
            </NavItem>
            <NavItem>
